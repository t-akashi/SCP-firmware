...
enum scmi_command_id {
    ...
    MOD_SCMI_NEGOTIATE_PROTOCOL_VERSION = 0x010,
};
...
enum scmi_pin_control_command_id {
    ...
    MOD_SCMI_PIN_CONTROL_FUNCTION_SELECT = 0x007,
    ...
    /* due to NEGOTIATE_PROTOCOL_VERSION */
    MOD_SCMI_PIN_CONTROL_COMMAND_COUNT = 0x011,
};
